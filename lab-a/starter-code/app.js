...
function multiply(a, b) { //eslint-disable-line
  let product = a * b;
  var array = [product,'The product of ' + a + ' and ' + b + ' is ' + product + '.'];
  return array;
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  let totaltemp = sum(a,b);
  let total = totaltemp[0];
  totaltemp = sum(total,c);
  total = totaltemp[0];
  let producttemp = multiply(a,b);
  let product = producttemp[0];
  producttemp = multiply(product,c);
  product = producttemp[0];
  var array = [total,product, a + ' and ' + b + ' and ' + c + ' sum to ' + total + '.'
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for(let i = 0; i < dynamicArray.length ; i++){
    multTempA = multiply(dynamicArray[i],product);
    product = multTempA[0];
    //console.log(product);
  }
